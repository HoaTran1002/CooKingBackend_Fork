export const env = {
  ...
  REFRESH_TOKEN:
    '1//04JXN8XG2pLrtCgYIARAAGAQSNwF-L9Ir9ZtrYuZpc7IozkDprDiSGbtS4vhGkTj3RjOtlLaOuoqo_fD6DOlmGTFhlv04-KsSrzY',
  SECRET_KEY_REFRESH_TOKEN:
    'PRIVATE_KEY_SIGN_TOKEN_SECRET_KEY_SIGN_TOKEN_REFRESH_TOKEN_skdkdbgbsbgjbsbvjbvsaF_HankjdvkbskbvbdvbdbvkdG_asdvjdsbvjbdjvbbsbdsavb_skdnvkdnvkndvkdnvnkvn',
  SECRET_KEY_ACCESS_TOKEN:
    'PRIVATE_KEY_SIGN_TOKEN_SECRET_KEY_SIGN_TOKEN_ACCESS_TOKEN_Udsnvknsdvnknvn_sknvkdnvnJdsvsSD_vdsjvnknJsdvdsvnk_Isnvsndvnsdvnknsdvnxvn_vsdjnJdsvJvsdnvkndsJ',
